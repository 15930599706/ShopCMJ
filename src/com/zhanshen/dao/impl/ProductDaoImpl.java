...
public class ProductDaoImpl implements ProductDao {
	 //------------------------new
		public int changepassword(String username,String oldpassword, String password) throws SQLException {
			QueryRunner queryRunner=new QueryRunner(DataSourceUtils.getDataSource());
			String sql="select * from user where username = ? and password = ?";
			User user=queryRunner.query(sql, new BeanHandler<>(User.class),username,oldpassword);
			if(user==null) {
				return 1;
			}
			else {
