...
//	  }
	 ...
	 * @throws IOException
	 */
	public void facelogin(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	public void login(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//String facename=req.getParameter("facename");
		String code = req.getParameter("code");
//		if(!facename.equals(null)) {
//			session.setAttribute("user", facename);
//			resp.sendRedirect(req.getContextPath()+"/");
//			return;
//		}
		String checkcode = (String) session.getAttribute("checkcode_session");
	...
	//修改密码
		public void changepass(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			try {
				System.out.println("starttry");
				int res=service.changepassword(username, oldpassword,password);
				if(res==0) {
					req.setAttribute("info", "密码修改成功");
					req.getRequestDispatcher("/password_eidt.jsp").forward(req, resp);
				}else {
					req.setAttribute("info", "密码修改失败");
					req.getRequestDispatcher("/password_eidt.jsp").forward(req, resp);
				}
			}catch(Exception e) {
