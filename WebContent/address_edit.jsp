					...
					<form action="${pageContext.request.contextPath}/privilege/privilegeServlet?method=addressUpdate"class="shop_form" method="post">
						<ul>
						  <li><input type="hidden" value="${address.did}" name="did"> </li>
							<li><label><span>*</span>收货人姓名：</label><input type="text" required="required"  class="form-text" name="name" value="${address.name }" /></li>
							<li><label><span>*</span>所在地：</label><input type="text" required="required"  class="form-text" value="中国" /></li>
							<li><label><span>*</span>省：</label><input type="text" required="required"  value="${address.province }" name="province"></li>
							<li><label><span>*</span>市：</label><input type="text" required="required"  value="${address.city }" name="city"></li>
							<li><label><span>*</span>区：</label><input type="text" required="required" value="${address.area }" name="area"></li>
							<li><label><span>*</span>详细地址：</label><input type="text" required="required"  value="${address.address }" name="address"></li>
