...
<body>
	...
	<div class="shop_member_bd clearfix">
		...
		<div class="shop_member_bd_left clearfix">
			...
			<dl>
				<dt>我的交易</dt>
				<dd><span><a href="/ShopCMJ/privilege/privilegeServlet?method=mycollect">我的收藏</a></span></dd>
			</dl>

			<dl>
				<dt>我的账户</dt>
				<dd><span><a href="/ShopCMJ/privilege/privilegeServlet?method=myhome">个人资料</a></span></dd>
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form action="productServlet?method=changepass" name="" class="shop_form" method="post">
						<ul>
							<input type="text" name="username" value="${user.username}" class="truename form-text" style="height:0px;border:0px;"/>
							...
							<li class="bn"><label>重复新密码：</label><input type="password" name="password" class="truename form-text" /></li>
